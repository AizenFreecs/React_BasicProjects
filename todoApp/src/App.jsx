    ...
    <TodoContextProvider value={{todos,addTodo,updateTodo,deleteTodo,toggleComplete}}>
     ...
     style={{
      backgroundImage: `url('https://images.pexels.com/photos/164005/pexels-photo-164005.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')`,
                ...
                <div className="w-full max-w-2xl mx-auto shadow-md rounded-lg px-4 py-3 text-white bg-slate-800 bg-opacity-50">
                    <h1 className="text-4xl font-bold text-center mb-8 mt-2">Todo List App</h1>
                    <div className="mb-4">
                        <TodoForm/>
                    </div>
